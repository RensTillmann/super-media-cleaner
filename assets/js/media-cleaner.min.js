...
(function($) { // Hide scope, no $ conflict
	...
	$(document).ready(function(){
        var node = document.querySelector('.smc-start-scan');
        if(node){
    ...
    function scan(offset){
        $.ajax({
            ...
            success: function (response) {
                ...
                if(json.log!==''){
                    debugger;
                    var node = document.querySelector('.smc-scan-log');
                    node.innerHTML += json.log;
                }
                if(typeof json.offset==='undefined' || json.offset===0){
                    debugger;
